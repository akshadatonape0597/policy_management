...
if __name__=="__main__":
    d={}
    df=pd.read_excel('C:/Users/Akshada Tonape/OneDrive - McKinsey & Company/Desktop/Python/inbound/input.xlsx')
    ...
    for key, value in d.items():    
        ...
        with open('outbound\pn-promo-live-'+str(key)+'.json', 'w') as outfile:
